...
const resources = {
  en: {
    translation: {
      ...
      waterDiet: {
        title: "Water & Diet",
        subtitle: "Record your daily water and salt intake",
        waterIntake: "Water Intake",
        saltIntake: "Salt Intake",
        waterUnit: "ml",
        saltUnit: "mg",
        dailyRecord: "Daily Record",
        enterWater: "Enter water intake",
        enterSalt: "Enter salt intake",
        success: "Water and salt intake saved successfully",
        warningHighSalt: "Your salt intake is high",
        warningHighWater: "Your water intake is high",
        enterBoth: "Please enter both water and salt intake",
        saveFailed: "Failed to save water and salt intake",
        loginFirst: "Please log in first",
        summaryTitle: "Latest Summary",
        waterGraph: "Water Intake Graph",
        saltGraph: "Salt Intake Graph",
      },
  ...
  ms: {
    translation: {
      ...
      waterDiet: {
        title: "Air & Diet",
        subtitle: "Rekod pengambilan air dan garam harian anda",
        waterIntake: "Pengambilan Air",
        saltIntake: "Pengambilan Garam",
        waterUnit: "ml",
        saltUnit: "mg",
        dailyRecord: "Rekod Harian",
        enterWater: "Masukkan pengambilan air",
        enterSalt: "Masukkan pengambilan garam",
        success: "Pengambilan air dan garam berjaya disimpan",
        warningHighSalt: "Pengambilan garam anda tinggi",
        warningHighWater: "Pengambilan air anda tinggi",
        enterBoth: "Sila masukkan pengambilan air dan garam",
        saveFailed: "Gagal menyimpan pengambilan air dan garam",
        loginFirst: "Sila log masuk dahulu",
        summaryTitle: "Ringkasan Terkini",
        waterGraph: "Graf Pengambilan Air",
        saltGraph: "Graf Pengambilan Garam",
      },
